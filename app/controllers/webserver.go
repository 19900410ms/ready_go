...
func apiCandleHandler(w http.ResponseWriter, r *http.Request) {
	...
	if ema != "" {
		...
		period2, err := strconv.Atoi(strEmaPeriod1)
		if strEmaPeriod2 == "" || err != nil || period2 < 0 {
			period2 = 14
		}
		period3, err := strconv.Atoi(strEmaPeriod1)
	...
	if macd != "" {
		strPeriod1 := r.URL.Query().Get("macPeriod1")
		strPeriod2 := r.URL.Query().Get("macPeriod2")
		strPeriod3 := r.URL.Query().Get("macPeriod3")
